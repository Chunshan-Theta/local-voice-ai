...
// import { createAgentConfig, fetchAgentConfig } from './utils';
...
async function createAgentConfig(apiResult: any, lang: Language): Promise<AgentConfig> {
  const instructions = `
  Now, please play the role of ${apiResult.prompt_name}, here are your role and more details:
  ## Your Role: ${apiResult.prompt_name}
  ${apiResult.prompt_personas}
  ## Your Conversation Partner
  ${apiResult.prompt_customers || 'General user'}
  ## Your Tool Usage Rules and Instructions
  ${apiResult.prompt_tool_logics || 'No specific tool instructions'}
  ## Your Voice Style
  ${apiResult.prompt_voice_styles || 'Natural and friendly'}
  ## Your Conversation Mode
  ${apiResult.prompt_conversation_modes || 'Interactive conversation'}
  ## Your Prohibited Phrases
  ${apiResult.prompt_prohibited_phrases || 'None specified'}
  ...
  useEffect(() => {
    ...
    const fetchAgentConfig = async () => {
      try {
        ...
        // Create agent config with the fetched data using our helper function
